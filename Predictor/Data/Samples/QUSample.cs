...
{
    public partial class QUSample : IFinancialSample
    {
        // Description MSFT Q 6/30/2008
        public string Description
        {
            get
            {
                return this.Ticker.Trim( ) + " Q " + this.Date.ToShortDateString( );
            }
        }
